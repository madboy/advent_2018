...
print("{}*{} {}".format(heavy_sleeper, heavy_sleep_minute, int(heavy_sleeper)*heavy_sleep_minute)) # 33 * 3023
# print(patterns.get(mostest_guard))
print("{}*{} {}".format(mostest_guard, mostest_minute, int(mostest_guard)*mostest_minute)) # 2719 * 36
